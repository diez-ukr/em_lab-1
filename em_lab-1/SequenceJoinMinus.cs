...
namespace em_lab_1
{
    class SequenceJoinMinus : IGenerator
    {
        private long x;
        private long seed;
        ...
        public SequenceJoinMinus(List<long> xList, IGenerator yGenerator, long seed)
        {
            this.xList = xList;
        ...
        public SequenceJoinMinus(IGenerator xGenerator, long xLength, IGenerator yGenerator, long seed)
        {
            this.yGenerator = yGenerator;
            this.seed = seed;
